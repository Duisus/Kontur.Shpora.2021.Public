...
namespace ThreadPool
{
    ...
    public class Program
    {
        ...
        {
            Enumerable.Range(0, iterations).AsParallel().WithDegreeOfParallelism(Environment.ProcessorCount)
                .ForAll(_ => TestOneAction());
        }
        ...
        public void TestConcurrency(int multiplier)
        {
            ...
            Enumerable.Range(0, Concurrency * multiplier).AsParallel()
                .WithDegreeOfParallelism(Environment.ProcessorCount * 4).ForAll(i => threadPool.EnqueueAction(() =>
                {
